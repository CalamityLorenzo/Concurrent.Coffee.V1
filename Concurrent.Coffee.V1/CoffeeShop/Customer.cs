...
namespace Concurrent.Coffee.V1.CoffeeShop
{
    internal class Customer
    {
        ...
        public IEnumerable<DrinkTypes> Order { get; }
        public string Name { get; }
        public Guid Id { get; }
        public IEnumerable<IDrink> Drinks { get { return _Drinks; } }
        public Customer(string Name, IEnumerable<DrinkTypes> Order)
        {
            this.Id = Guid.NewGuid();
            this.Name = Name;
            this.Order = new List<DrinkTypes>(Order);
            this._Drinks = new List<IDrink>();
        }

        private Customer (string Name, IEnumerable<DrinkTypes> Order, Guid Id, IEnumerable<IDrink> Drinks)
        {
            this.Name = Name;
            this.Id = Id;
            this.Order = new List<DrinkTypes>(Order);
